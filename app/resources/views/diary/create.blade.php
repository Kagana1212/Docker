    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form action="{{ route('diary.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="question_answer" rows="3"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm border p-2 focus:ring-blue-500 focus:border-blue-500">{{ old('question_answer') }}</textarea>
            </div>

            <div class="flex justify-between items-center">
                <a href="{{ route('diary.calendar') }}" class="text-sm text-gray-500 hover:underline">戻る</a>
                <button type="submit"
